    ...
    render() {
        ...
        return(
          <section className="padding-all bg-000 minheight-100">
            ...
            <div className="textclolor-white width-100 font-size-normal text-align-center margin-top-2r line-height-1f">三大核心理念</div>
            <div className="textclolor-white width-100 font-size-default text-align-center line-height-2r">教育（Education）、社交（Social）、管理（Management）</div>
            <div className="textcolor-515151 width-100 font-size-small text-align-center line-height-1f ">For 用户：</div>
            <div className="textcolor-515151 width-100 font-size-small text-align-center line-height-1f ">#精准计划 培养高效运动意识#</div>
            <div className="textcolor-515151 width-100 font-size-small text-align-center line-height-1f ">无论你是入门小白、进阶选手还是健身老司机</div>
            <div className="textcolor-515151 width-100 font-size-small text-align-center line-height-1f ">我们将提供一套完整的运动计划，精准训练</div>
            <div className="textcolor-515151 width-100 font-size-small text-align-center line-height-1f ">更客观的更全面的提供技术指导</div>
            <div className="textcolor-515151 width-100 font-size-small text-align-center line-height-1f ">培训、挖掘你的运动潜能</div>
            <div className="textcolor-515151 width-100 font-size-small text-align-center line-height-1f ">#抱团打卡 组建健身社交网#</div>
            <div className="textcolor-515151 width-100 font-size-small text-align-center line-height-1f ">线下小班入门课程、EasyCamp训练营</div>
            <div className="textcolor-515151 width-100 font-size-small text-align-center line-height-1f ">线上教练指导反馈，打卡排名</div>
            <div className="textcolor-515151 width-100 font-size-small text-align-center line-height-1f ">只要你够自觉够自律</div>
            <div className="textcolor-515151 width-100 font-size-small text-align-center line-height-1f ">你永远都不孤单</div>
